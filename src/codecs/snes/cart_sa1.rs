...
const CODEC_DESC: &str = "SNES SA-1 ROM decoder

Separates a Super Nintendo Entertainment System/Super Famicom SA-1 ROM into 64 KiB banks, plus a copier header if present.
